...
const Help = () => {
  return (
    <section className="px-[35px] lg:px-[70px] text-white">
      <div className="bg-homeHero min-h-[447px] rounded-lg text-white flex flex-col lg:flex-row items-center justify-between">
        <div className="py-[40px] p-[20px] lg:pl-[60px] w-full lg:w-1/2">
          <h2 className="text-3xl lg:text-[50px] leading-[1.2] mb-4 capitalize text-center lg:text-start">
        ...
        <div className="w-full lg:w-1/2 p-[20px] lg:p-[60px] grid grid-cols-1 lg:grid-cols-3 items-center justify-center gap-5">
          ...
          <div className="border-[0.5px] border-slate-100 py-3 px-4 rounded-md cursor-pointer hover:scale-105 transition-all duration-300  mb-10">
